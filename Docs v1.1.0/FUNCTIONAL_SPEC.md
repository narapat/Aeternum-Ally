...
AeternumAlly is a multi-tenant web application that guides SMEs through a structured, AI-assisted sustainability management workflow. The output is a publishable Sustainability Statement compliant with ESRS (European Sustainability Reporting Standards) and cross-referenced to GRI standards, along with actionable tasks and carbon tracking.
