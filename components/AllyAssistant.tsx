...
export const AllyAssistant: React.FC<AllyAssistantProps> = ({ userEmail, companyName, userRole, userId, orgId }) => {
  ...
  const [messages, setMessages] = useState<Array<{ role: 'user' | 'assistant', text: string }>>([
    { role: 'assistant', text: "Hi! I'm **Ally**, your AI assistant. How can I help you today?\n\nPlease note that I am an AI and can sometimes make mistakes, but I will try my best to help you succeed in using the platform!\n\n**Notice**: To improve our service, conversations are recorded for analysis and system improvement.\n\nYou can also refer to the [User Manual](https://github.com/narapat/Aeternum-Ally/blob/main/Docs%20v1.1.0/USER_MANUAL.md) for guidance!" }
  ]);
